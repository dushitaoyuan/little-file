...
public class FilenameUtils {
    ...
    public static String getFileNameRandom(String fileName) {
        return getPrefix(fileName) + "_" + generateShortUuid() + "." + getExtension(fileName);
    }
    ...
    public static void main(String[] args) {
        System.out.println(getFileNameRandom("11.pdf"));
    }
